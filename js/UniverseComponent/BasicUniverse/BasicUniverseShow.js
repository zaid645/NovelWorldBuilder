            ...
            <div class="flex-1 w-full">
                ...
                <div class="flex sm:flex-col gap-2 w-full sm:w-auto shrink-0">
                    <div class="flex flex-1 gap-1">
                        <button onclick="app.exportSpecificUniverse('${univ.id}', 'json')" title="Ekspor JSON Lengkap" class="flex-1 bg-slate-700 hover:bg-slate-600 px-2.5 py-1.5 rounded text-xs text-indigo-300 border border-slate-600 transition flex items-center justify-center font-medium">
                            <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
                            JSON
                        </button>
                        <button onclick="app.exportSpecificUniverse('${univ.id}', 'md')" title="Ekspor Markdown (.md)" class="flex-1 bg-slate-700 hover:bg-slate-600 px-2.5 py-1.5 rounded text-xs text-emerald-300 border border-slate-600 transition flex items-center justify-center font-medium">
                            ...
                            MD
                        <button onclick="app.exportSpecificUniverse('${univ.id}', 'pdf')" title="Ekspor PDF Dokumen" class="flex-1 bg-slate-700 hover:bg-slate-600 px-2 py-1.5 rounded text-xs text-rose-300 border border-slate-600 transition flex items-center justify-center font-medium">
